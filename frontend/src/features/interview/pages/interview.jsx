...
const QuestionCard = () => (
  <div className="q-card">
    <div className="q-card__header">
      ...
      <p className="q-card__question">How does the Node.js event loop work?</p>
...
const RoadMapDay = () => (
  <div className="roadmap-day">
    <div className="roadmap-day__header">
      <span className="roadmap-day__badge">Day 1</span>
      <h3 className="roadmap-day__focus">Node.js Internals and Performance</h3>
    </div>
      ...
      <div className="interview-layout">
        ...
        <nav className="interview-nav">
          <div className="nav-content">
            ...
            {NAV_ITEMS.map((item) => (
              <button key={item.id} className="interview-nav__item">
        ...
        <main className="interview-content">
          <section>
            <div className="content-header">
              ...
              <span className="content-header__count">5 questions</span>
            </div>
        ...
        <aside className="interview-sidebar">
          ...
          <div className="skill-gaps">
            ...
            <div className="skill-gaps__list">
              <span className="skill-tag skill-tag--medium">
                Message Queues (Kafka/RabbitMQ)
              </span>
              <span className="skill-tag skill-tag--low">Advanced DevOps</span>
              <span className="skill-tag skill-tag--medium">
                Distributed Systems
              </span>
            </div>
